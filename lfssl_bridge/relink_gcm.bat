...
g++ -std=c++23 -c "..\..\LFSSL - Lamia Fabrica SSL\src\crypto\aes256_gcm_hardware.cpp" -o lfssl_aes256_gcm_hardware.o -O2 -Wall -DBUILD_DLL -maes -msse2 -msse4.1 -I"..\..\LFSSL - Lamia Fabrica SSL\include" -I"..\..\LFSSL - Lamia Fabrica SSL\lib\kyber-main\ref" -I"..\..\LFSSL - Lamia Fabrica SSL\lib\dilithium-master\ref"
