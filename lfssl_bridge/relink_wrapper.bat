...
g++ -std=c++23 -c cerberus_lfssl_wrapper.cpp -o wrapper.o -O2 -Wall -DBUILD_DLL -mavx2 -I"..\..\LFSSL - Lamia Fabrica SSL\include" -I"..\..\LFSSL - Lamia Fabrica SSL\lib\kyber-main\ref" -I"..\..\LFSSL - Lamia Fabrica SSL\lib\dilithium-master\ref"
