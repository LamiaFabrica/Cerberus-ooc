@echo off
setlocal
REM Rebuild wrapper only and relink DLL

cd /d "C:\McMaker Projects\Projects\Cerberus - Copy\lfssl_bridge"

echo Compiling wrapper...
g++ -std=c++23 -c cerberus_lfssl_wrapper.cpp -o wrapper.o -O2 -Wall -DBUILD_DLL -maes -msse2 -msse4.1 -I"..\..\LFSSL - Lamia Fabrica SSL\include" -I"..\..\LFSSL - Lamia Fabrica SSL\lib\kyber-main\ref" -I"..\..\LFSSL - Lamia Fabrica SSL\lib\dilithium-master\ref"
