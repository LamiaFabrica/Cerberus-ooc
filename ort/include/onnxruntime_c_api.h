...
#define ORT_EXPORT
#endif
// MinGW GCC on x86_64 does not support _stdcall in function pointer struct members.
// Force ORT_API_CALL to empty on MinGW x86_64 to avoid parse errors.
...
// _Return_type_success_ is an MSVC SAL annotation not understood by GCC/MinGW.
// Suppress it on MinGW to avoid parse errors.
#ifdef _WIN32
#if defined(__MINGW32__) || defined(__MINGW64__)
